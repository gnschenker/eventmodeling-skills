...
template.innerHTML = `
  <link rel="stylesheet" href="/slices/delete-todo/delete-todo.css" />
  <div class="delete-todo-card">
    <h2>Delete Todo</h2>
...
class DeleteTodo extends HTMLElement {
  connectedCallback() {
    ...
    this.shadowRoot.querySelector('.btn-cancel').addEventListener('click', () => {
      this.dispatchEvent(new CustomEvent('dt-cancel', { bubbles: true, composed: true }));
    });
  }
...
customElements.define('delete-todo', DeleteTodo);
